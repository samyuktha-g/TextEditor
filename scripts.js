    ...
    class View {
        constructor() {
            ...
            var icons = ['<i class = "fa fa-bold" id="bold"></i>', '<i class = "fa fa-italic"></i>',
                ...
                '<i class="fa fa-list-ol"></i>', '<i class="fa fa-list-ul"></i>'
            ];
            ...
            for (var i = 0; i < icons.length; i++) {
                ...
                btns[i].addEventListener("click", function(e) {
                    ...
                    if (e_var == "fa fa-folder-open" || e_var == "fa fa-file-image-o" || e_var == "fa fa-quote-right" || e_var == 7 || e_var == 8) {
